  ...
  return (
    <div className="flex flex-col h-full bg-white rounded-lg shadow-lg">
      ...
      <div className="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-blue-600 to-blue-700">
        <h2 className="text-xl font-bold text-white">Assistente IA de Imóveis</h2>
        <p className="text-sm text-blue-100 mt-1">
          {propertyContext ? 'Conversando sobre um imóvel específico' : 'Tire suas dúvidas sobre imóveis de luxo'}
        </p>
      </div>
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-4">
        {messages.length === 0 && (
          <div className="text-center text-gray-500 mt-8">
            ...
            <p className="text-sm mt-2">Faça perguntas sobre imóveis, preços, localizações e muito mais!</p>
          </div>
        )}
