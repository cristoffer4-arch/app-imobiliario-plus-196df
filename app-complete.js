...
// Version: 2.0 (com Sistema de Preços + Voucher + OAuth + Geolocalização)
// ============================================================================
...
const CONFIG = {
    ...
    // APIs
    GEMINI_API_KEY: '',  // SET IN .env (fallback for Premium/Enterprise)
...
if (typeof process !== 'undefined' && process.env) {
    ...
    CONFIG.GEMINI_API_KEY = process.env.GOOGLE_GEMINI_KEY || CONFIG.GEMINI_API_KEY;
    CONFIG.CASAFARI_API_KEY = process.env.CASAFARI_API_KEY || CONFIG.CASAFARI_API_KEY;
    CONFIG.STRIPE_PUBLISHABLE_KEY = process.env.STRIPE_PUBLISHABLE_KEY || CONFIG.STRIPE_PUBLISHABLE_KEY;
}
...
async function handleAuthSuccess(user) {
    ...
    // Check if first login (show voucher modal)
...
// ✅ OAuth Gemini Integration
// ✅ Geolocation (GPS)
// ✅ 13 Modules (10 original + 3 new)
// ✅ Gamification System
// ✅ XP & Levels
// ✅ Feature Access Control
// ✅ i18n Support
// ✅ Complete UI utilities
// ============================================================================